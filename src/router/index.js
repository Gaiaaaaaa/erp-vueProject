...
export const asyncRouterMap = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: '定价管理',
        // meta: { code: '/house/house' },
        component: _import('house/pricingManagement')
      },
      {
        path: 'allOfHouse',
        name: '房源查询',
...

  {
    ...
    redirect: 'noredirect',
    icon: 'user',
    meta: { code: '/makeTicketManage/management' },
    name: '开票管理',
    children: [
      {
        path: 'summary',
        meta: { code: '/makeTicketManage/summary' },
        name: '开票总表',
        component: _import('makeTicketManage/summary/index')
      },
      {
        path: 'particulars',
        meta: { code: '/makeTicketManage/particulars' },
        name: '开票明细',
